              ...
              <div>
                ...
                <div className="space-y-4 text-sm text-gray-500 leading-relaxed">
                  ...
                  <p>
                    ...
                    tours to AI-powered property matching — to deliver a
                    seamless, modern real estate experience without losing the
                    human touch that makes all the difference.
                  </p>
                </div>
                <Link
                  href="/contact"
        ...
        <section className="py-20 bg-white px-4 sm:px-6 lg:px-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-sm max-w-md mx-auto mb-8">
              ...
              and a shared passion for exceptional real estate.
            </p>
            <Link
              href="/team"
