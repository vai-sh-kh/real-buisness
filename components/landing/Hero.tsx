...
export function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-brand-charcoal flex flex-col overflow-hidden">
      {/* Background image */}
      ...
      <div className="relative z-10 flex flex-col flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between flex-1 pt-28 pb-14 gap-10">
          ...
          <div className="lg:max-w-3xl">
            ...
            >
              <span className="h-px w-10 bg-brand-gold/60 inline-block" />
              <span className="text-brand-gold/90 text-xs tracking-[0.2em] uppercase">
                Premium Real Estate
              </span>
            </motion.p>
            ...
            <motion.h1
              ...
              className="font-heading text-5xl sm:text-6xl lg:text-[82px] font-bold text-white leading-[0.95] tracking-tight"
            >
              Find a place
              <br />
              you will call
          ...
          >
            ...
            <Link
              href="/properties"
              className="inline-flex items-center bg-brand-gold text-white text-sm font-semibold px-7 py-3.5 rounded-full hover:opacity-90 transition-opacity"
            >
              Book a Consultation
            </Link>
          </motion.div>
        ...
        >
          <div className="bg-white rounded-2xl p-2 flex flex-col sm:flex-row items-stretch gap-2 shadow-2xl">
            ...
            {/* Filters */}
            <button className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-gray-200 text-sm text-gray-600 hover:border-brand-gold/50 transition-colors sm:shrink-0">
            ...
            <Link
              ...
              className="bg-brand-charcoal text-white text-sm font-semibold px-6 py-3 rounded-xl hover:opacity-90 transition-opacity whitespace-nowrap text-center sm:shrink-0"
            >
              Show Properties
            </Link>
          </div>
